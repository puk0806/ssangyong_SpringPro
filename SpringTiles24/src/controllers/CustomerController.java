...
public class CustomerController {
	...
	public String notices(
		...
		// 뷰 이름 == Tiles 연동 -> View 객체 생성
		String viewName = "customer.notice";
		// viewName을 가지고 tiles-defs.xml 파일
		return viewName;
	}
	...
	*/
	...
	public ModelAndView noticeDetail(HttpSession session, @RequestParam("seq") String seq)
		...
		// String viewName = "noticeDetail.jsp";
		String viewName = "customer.noticeDetail";
		ModelAndView mv = new ModelAndView(viewName);
		mv.addObject("notice", notice);
		return mv; //
	}
	...
	public String noticeReg(  ){
		...
		String viewName = "customer.noticeReg";
		return viewName;
	}
